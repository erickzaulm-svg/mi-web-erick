    ...
    <>
      ...
      <div className="bg-white/50 rounded-2xl p-3 mb-4 shadow-sm border border-white/60">
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="bg-white/40 p-2 rounded-xl border border-white/60 flex items-center gap-2"><div className="w-6 h-6 rounded-full bg-blue-900/20 border border-white flex items-center justify-center flex-shrink-0"><span className="font-bold text-blue-900 text-[10px]">ST</span></div><div><p className="text-[9px] font-bold text-cyan-800 uppercase tracking-wider opacity-70">Steam</p><h4 className="font-extrabold text-cyan-900 text-xs">erickzaulm</h4></div></div>
          <div className="bg-white/40 p-2 rounded-xl border border-white/60 flex items-center gap-2"><div className="w-6 h-6 rounded-full bg-green-600/20 border border-white flex items-center justify-center flex-shrink-0"><span className="font-bold text-green-700 text-[10px]">XB</span></div><div><p className="text-[9px] font-bold text-cyan-800 uppercase tracking-wider opacity-70">Minecraft Bedrock</p><h4 className="font-extrabold text-cyan-900 text-xs">EzCarti4640</h4></div></div>
          <div className="bg-white/40 p-2 rounded-xl border border-white/60 flex items-center gap-2"><div className="w-6 h-6 rounded-full bg-indigo-600/20 border border-white flex items-center justify-center flex-shrink-0"><span className="font-bold text-indigo-700 text-[10px]">DC</span></div><div><p className="text-[9px] font-bold text-cyan-800 uppercase tracking-wider opacity-70">Discord</p><h4 className="font-extrabold text-cyan-900 text-xs">Erickelrapero67</h4></div></div>
          <div className="bg-white/40 p-2 rounded-xl border border-white/60 flex items-center gap-2"><div className="w-6 h-6 rounded-full bg-red-600/20 border border-white flex items-center justify-center flex-shrink-0"><span className="font-bold text-red-700 text-[10px]">RG</span></div><div><p className="text-[9px] font-bold text-cyan-800 uppercase tracking-wider opacity-70">Roblox</p><h4 className="font-extrabold text-cyan-900 text-xs"><a href="">EZ_CARTII</a></h4></div></div>
        </div>
      </div>
